...
class PDDCrawler:
    def __init__(self):
        ...
        self.user_agents = [
            ...
            'Mozilla/5.0 (Linux; Android 10; GM1910) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36',
    ...
    def search_products(self, keyword, page=1, limit=10):
        ...
        try:
            ...
            # 获取必要的Cookie
            if not self.get_dynamic_cookie():
                return []
