...
# TODO 这段代码还需不需要进行验证测试?
# 刚刚问过AI了,多多进宝推手是没有资质调用pdd.goods.information.get这个接口的
# 多多进宝推手只能获取:pdd.ddk.goods.detail这个接口的信息
import hashlib
import time
import requests
...
# https://mobile.yangkeduo.com/goods.html?goods_id=62262510595&uin=TA3TZLNC3H3RIQWE4W2C4Y3OIA_GEXDA
...
def get_goods_sign(goods_id):
    ...
    params = {
        ...
        "access_token": access_token,
        "timestamp": timestamp,
        "keyword": goods_id,     # ps_value,    # goods_id,
...
if __name__ == "__main__":
    try:
        ...
        print("正在获取GoodsSign...")
        # goods_sign = get_goods_sign(goods_id=goods_id)
        # goods_sign = generate_promotion_url()
        goods_sign = 'E9f2KcsDPiZuuavBzuXfDnnDScaoJrle_JQ1P2mm4y4'
        ...
        print("\n正在获取商品详情...")
        goods_detail = get_goods_detail(goods_sign=goods_sign)
